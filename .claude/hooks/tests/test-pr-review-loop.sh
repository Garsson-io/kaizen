#!/bin/bash
# Tests for kaizen-pr-review-loop.sh — state file keying by PR URL
...
# SUT: kaizen-pr-review-loop.sh merge handler output
...
# SUT: kaizen-pr-review-loop.sh merge-from-main detection in git push handler
teardown
setup
...
# SUT: kaizen-pr-review-loop.sh git push handler with normal commit
teardown
setup
...
# SUT: kaizen-pr-review-loop.sh merge-from-main detection specificity
teardown
setup
...
# SUT: kaizen-pr-review-loop.sh TRIGGER 3 (gh pr diff handler)
...
# SUT: kaizen-pr-review-loop.sh guard before TRIGGER 3
...
# status to escalated.
# SUT: kaizen-pr-review-loop.sh git push handler escalation path (lines 315-328)
...
# SUT: kaizen-pr-review-loop.sh git push handler guard for escalated status
# VERIFICATION: No output produced.
...
# SUT: kaizen-pr-review-loop.sh TRIGGER 1 (gh pr create)
teardown
setup
...
# SUT: kaizen-pr-review-loop.sh TRIGGER 3 (gh pr diff)
teardown
setup
...
# SUT: kaizen-pr-review-loop.sh git push handler with diff-size scaling
teardown
setup
