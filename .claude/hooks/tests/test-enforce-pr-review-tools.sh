#!/bin/bash
# Tests for kaizen-enforce-pr-review-tools.sh — PreToolUse gate for non-Bash tools
...
HOOK="$(dirname "$0")/../kaizen-enforce-pr-review-tools.sh"
setup_test_env
...
# SUT: kaizen-enforce-pr-review-tools.sh with empty STATE_DIR
...
# SUT: kaizen-enforce-pr-review-tools.sh via state-utils.sh staleness check
