...
| Hook-activation verdict | scripts/auto-dent-hook-activation.ts: evaluateHookActivation() from the session system.init event | scripts/auto-dent-hook-activation.ts:function:evaluateHookActivation | yes |
