  ...
  computedVerdicts: [
    ...
    },
    {
      ...
      producerSignatures: [
        ...
        'scripts/workflow-gate-ledger.ts:function:deriveWorkflowGateVerdict',
        'scripts/workflow-gate-ledger.ts:interface:WorkflowGateVerdict',
      ],
      sourceEvidence: [
        ...
        { file: 'scripts/workflow-gate-ledger.ts', tokens: ['deriveWorkflowGateVerdict', 'WorkflowGateVerdict'] },
      ],
      terminalCritical: true,
    },
    {
