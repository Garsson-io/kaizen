...
This violates workspace isolation even though the branch isn't `main`. What matters is **where** the work happens, not what branch it's on. See `.agents/kaizen/README.md` for the full rationale.
