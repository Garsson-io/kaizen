...
needs: [diff]
high_when:
  - "Diff contains try/catch, .catch(), Promise, async/await"
  - "Diff uses child_process, fs, network calls, or external APIs"
  - "Diff modifies error handling paths or fallback logic"
low_when:
  - "Diff is pure type definitions or interfaces"
  - "Diff is docs, comments, or config only"
  - "Diff contains no failable operations"
---

Your task: Review PR {{pr_url}} for silent error-handling failures.
