...
export const PROVIDER_CAPABILITIES: readonly ProviderCapability[] = [
  ...
  { provider: 'codex', phase: 'review', billingMode: 'subscription-cli', fit: 'works', acceptedForUnattended: true, rationale: 'Codex review runs through the shared structured review battery under subscription with terminal/failure evidence checks.' },
